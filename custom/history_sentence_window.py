...
class HistorySentenceWindowNodeParser(NodeParser):
    ...
    def book_name(cls, path):
        ...
        _mapping["baihuabeishi"] = "北史"
        _mapping["baihuachenshu"] = "陈书"
        _mapping["baihuahanshu"] = "汉书"
        _mapping["baihuahouhanshu"] = "后汉书"
        _mapping["baihuajinshi"] = "金史"  
        _mapping["baihuajinshu"] = "晋书" 
        _mapping["baihuajiutangshu"] = "旧唐书"
        _mapping["baihuajiuwudaishi"] = "旧五代史"
        _mapping["baihualiangshu"] = "梁书"
        _mapping["baihualiaoshi"] = "辽史"
        _mapping["baihuamingshi"] = "明史"
        _mapping["baihuananqishu"] = "南齐书"
        _mapping["baihuananshi"] = "南史"
        _mapping["baihuasanguozhi"] = "三国志"
        _mapping["baihuashiji"] = "史记"
        _mapping["baihuasongshi"] = "宋史"
        _mapping["baihuasongshu"] = "宋书"
        _mapping["baihuasuishu"] = "隋史" 
        _mapping["baihuaweishu"] = "魏书"
        _mapping["baihuaxintangshi"] = "新唐史"
        _mapping["baihuaxinwudaishi"] = "新五代史"
        _mapping["baihuayuanshi"] = "元史"
        _mapping["baihuazhoushu"] = "周书"
        _mapping["DengXiaoPingShiDai__FuGaoYi"] = "邓小平时代-傅高义"
